...
NormalStart:
	...
	Gui, Add, Button, x9 y435 w80 gButtonDefaults, Set Default
	Gui, Add, Button, x+9 y435 w80 gButtonIniMake, Create INI File
	Gui, Add, Button, x+9 y435 w80 gButtonClicks, Set Clicks
	Gui, Show
	return	
	;}
	;{ Submit
